...
namespace ARGame.Utils
{
    public class LevelManager
    {
        ...
        public List<AbstractLevel> Levels { get; private set; }
        ...
        public LevelManager(AbstractGame game) 
        {
            this.game = game;
        }
        public void Load(string gameFile) 
        {
            ...
            foreach (XElement levelNode in levelElements)
            {
                ...
                ciObject = tObject.GetConstructor(new Type[] { typeof(AbstractGame) });
                AbstractLevel levelObj = ciObject.Invoke(new Object[] { game }) as AbstractLevel;
