...
{
    public class SceneAsteroid: GameModel.Asteroid, GameObject
    {
        ...
        public SceneAsteroid(float mass, Vector3 position, Vector3 velocity, bool inertial)
        ...
        public override float Radius { get { return 32 * scale.X - 2; } }
