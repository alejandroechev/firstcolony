...
namespace Astronautas2D.Levels
{
    public class SoloLevel : TeamLevel
    {
        ...
        public SoloLevel(int levelIndex, Objective o, bool narrative, MiceManager mM, GameObjectFactory of, GUIElementFactory gf, Rectangle boundries, bool[] conditions, float chargeValue, bool allAtOnce)
            : base(levelIndex, o, narrative, mM, of, gf, boundries, conditions, chargeValue, allAtOnce)
        {
