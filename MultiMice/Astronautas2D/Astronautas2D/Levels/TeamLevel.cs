...
namespace Astronautas2D.Levels
{
    ...
    public class TeamLevel : AstroLib.AbstractLevel
    {
        ...
        public TeamLevel(int levelIndex, Objective o, bool narrative ,MiceManager mM, GameObjectFactory of, GUIElementFactory gf, Rectangle boundries, bool[] conditions, float chargeValue, bool allAtOnce)
            :base()
        {
        ...
        {
            background = objectFactory.getBackground((backgrounds)levelIndex);
        }
