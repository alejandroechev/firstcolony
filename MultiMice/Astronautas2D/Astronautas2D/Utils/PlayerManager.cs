    ...
    public class PlayerManager
    {
        ...
        public void Update(float elapsedTime)
        {
            ...
            if (teamMode)
            {
                ...
                this.huds[(int)playerId.team].UpdateScore(scoreManager.getScore(playerId.team).ToString());
            }
            else
            {
                this.huds[(int)playerId.circle].UpdateTime(timeManager.getPlayerTime(playerId.circle));
                this.huds[(int)playerId.circle].UpdateScore(scoreManager.getScore(playerId.circle).ToString());
                this.huds[(int)playerId.square].UpdateTime(timeManager.getPlayerTime(playerId.square));
                this.huds[(int)playerId.square].UpdateScore(scoreManager.getScore(playerId.square).ToString());
                this.huds[(int)playerId.triangle].UpdateTime(timeManager.getPlayerTime(playerId.triangle));
                this.huds[(int)playerId.triangle].UpdateScore(scoreManager.getScore(playerId.triangle).ToString());
            }
        }
