    ...
    public class GameObjectFactory
    {
            ...
            if (inOrder)
            {
                ...
                for (int i = 0; i < randomPositionsUsed.Length; i++)
                {
                    if (randomPositionsUsed[i])
                    {
                        ...
                        randomPositionsUsed[i] = false;
                        aux = (i + 1) % randomPositionsUsed.Length;
                        break;
                    }
                }
        ...
        public void LoadContent(ContentManager content)
        {
            if (narrative)
            {
                ...
                backgroundTextures[(int)backgrounds.tutorial8] = content.Load<Texture2D>("Sprites\\Narrative\\Backgrounds\\Tutorial");
                backgroundTextures[(int)backgrounds.mission1] = content.Load<Texture2D>("Sprites\\Narrative\\Backgrounds\\Mission");
            ...
            else
            {
                ...
                // Fondos
                backgroundTextures[(int)backgrounds.tutorial1] = content.Load<Texture2D>("Sprites\\NoNarrative\\Backgrounds\\White");
                backgroundTextures[(int)backgrounds.tutorial2] = content.Load<Texture2D>("Sprites\\NoNarrative\\Backgrounds\\White");
        ...
        public Texture2D getBackground(backgrounds bg)
        {
            return backgroundTextures[(int)bg];
        }
