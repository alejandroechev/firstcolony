...
namespace GameModel
{
    public class Astronaut : IPhysicBody
    {
        ...
        public bool ActiveCollisions { get { return true; } }
        public bool ActiveForces { get { return isActive; } set { isActive = value; } }

        private float charge, mass;
        private Vector3 position;

        //IElectricBody
        public virtual float Charge { get { if (isActive) return charge; else return 0; } set { charge = value; } }       
        ...
        private string materialName = "astronaut";
