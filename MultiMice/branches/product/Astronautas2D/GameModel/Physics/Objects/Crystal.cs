...
namespace GameModel
{
    public class Crystal : KinematicBody, IPhysicBody
    {
        ...
        private bool activeCollisions;
        public bool ActiveCollisions { get { return activeCollisions; } set { activeCollisions = value; } }
        private bool activeForces;
        public bool ActiveForces { get { return activeForces; } set { activeForces = value; } }
        protected bool isDivisible;
        public bool IsDivisible { get { return isDivisible; } }
            ...
            : base(mass, position, velocity, inertial)
        {
            ...
            this.activeForces = isAlive;
            this.activeCollisions = isAlive;
